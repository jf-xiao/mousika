...
public class DaoParams {
    ...
    public DaoParams(String servicePack, String modelClass, String daoPack, String modelPack,
    ...
    public DaoParams(String servicePack, String modelClass, String daoPack, String modelPack, String serviceImplPack, String modelField, String modelRemarks) {
        super();
        this.servicePack = servicePack;
        this.modelClass = modelClass;
        this.daoPack = daoPack;
