...
public class ColumnInfo {
    ...
    public ColumnInfo(String tableCat, String tableSchem, String tableName, String columnName, int dataType,
            String typeName, int columnSize, String bufferLength, int decimalDigits, String numPrecRadix, int nullable,
            String remarks, String columnDef, int sqlDataType, int sqlDatetimeSub, int charOctetLength,
            int ordinalPosition, String isNullable, String scopeCatlog, String scopeSchema, String scopeTable,
            short sourceDataType, String isAutoincrement) {
        super();
    ...
    public String toString() {
        return "ColumnInfo [tableCat=" + tableCat + ", tableSchem=" + tableSchem + ", tableName=" + tableName
                ...
                + columnSize + ", bufferLength=" + bufferLength + ", decimalDigits=" + decimalDigits
                + ", numPrecRadix=" + numPrecRadix + ", nullable=" + nullable + ", remarks=" + remarks + ", columnDef="
