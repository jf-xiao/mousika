...
public class MySqlOperator {
    ...
    public static List<TableInfo> loadTableInfo(JdbcConfigInfo jdbcConfigInfo) {
        ...
        try {
            ...
            ResultSet rs = metaData.getTables(conn.getCatalog(), jdbcConfigInfo.getUsername().toUpperCase(), null, new String[]{"TABLE"});
            if("ORACLE".equals(jdbcConfigInfo.getType().toUpperCase())){
                rs = metaData.getTables(conn.getCatalog(), jdbcConfigInfo.getUsername().toUpperCase(), null, new String[]{"TABLE"});
